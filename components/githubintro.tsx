        ...
        <div id="markdown-preview">
          ...
          <div className="my-2">
            ...
            <a
              ...
              target="blank"
            >
              ahmaddin.netlify.app/ahmaddin.pdf
            </a>
          </div>
          <div className="my-2">
            📫 How to reach me <b>ahmaddin1000@gmail.com</b>
          </div>
          <div className="flex flex-wrap items-end justify-start">
            <h3 className="w-full text-lg sm:text-xl">Connect with me:</h3>
            <a
              className="m-2 text-blue-700 no-underline"
