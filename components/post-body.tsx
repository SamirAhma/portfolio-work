  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex">
        <a
          href={demoLink}
          className="flex px-4 py-2 font-medium text-white bg-green-500 rounded-lg hover:bg-green-600"
        ...
        <a
          href={demoLink}
          className="flex px-4 py-2 mx-4 font-medium text-white bg-blue-500 rounded-lg hover:bg-blue-600"
          target="_blank"
          rel="noopener noreferrer"
        >
          <div className="flex items-center justify-center mr-2">
